      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">Günlük Hedef İlerlemesi</span>
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-sm text-muted-foreground">
                      {subjectHours > 0 ? `${subjectHours}sa ` : ''}{subjectMins}dk
                    </span>
                  </div>
                )
              })}
        ...
        {totalMinutes === 0 && (
          <div className="text-center py-4 text-muted-foreground">
            ...
            <p className="text-sm">Bugün ders çalışma oturumu kaydedilmedi.</p>
            <p className="text-xs">İlerlemenizi görmek için çalışmaya başlayın!</p>
          </div>
        )}
      </CardContent>
    </Card>
